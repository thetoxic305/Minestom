...
public sealed interface Biome extends Biomes, ProtocolObject permits BiomeImpl {
    ...
    static @NotNull DynamicRegistry<Biome> createDefaultRegistry() {
        return DynamicRegistry.create(
                ...
                (key, props) -> new BiomeImpl(Registry.biome(key, props)),
    ...
    enum Precipitation {
        ...
        public static final BinaryTagSerializer<Precipitation> NBT_TYPE = BinaryTagSerializer.fromEnumStringable(Precipitation.class);
    }
